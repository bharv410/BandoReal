 ...
 */
public class MyObservableGridView extends CustomGridViewWithHeader implements Scrollable {
    ...
    public MyObservableGridView(Context context) {
        super(context);
        init();
    }

    public MyObservableGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyObservableGridView(Context context, AttributeSet attrs, int defStyle) {
...
//    }
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = MyObservableGridView.this.getMeasuredWidth()
                    - MyObservableGridView.this.getPaddingLeft()
                    - MyObservableGridView.this.getPaddingRight();
